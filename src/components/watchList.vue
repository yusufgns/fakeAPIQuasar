        ...
        <div v-for="state in states" class="w-[21cm] h-[29.7cm] bg-white pt-[6px] text-[13px]">
            ...
            <div class="watchMainDiv">
                <div class="watchRborder">
                    <div class="watchIMG">
                        <img class="imgWH" v-if="state.data1.imageSrc !== null" :src="state.data1.imageSrc">
                    </div>
                ...
                <div class="watchLborder">
                    <div class="watchIMG">
                        <img class="imgWH" v-if="state.data2.imageSrc !== null" :src="state.data2.imageSrc">
                    </div>
            ...
            <div class="watchMainDiv">
                <div class="watchRborder">
                    <div class="watchIMG">
                        <img class="imgWH" v-if="state.data3.imageSrc !== null" :src="state.data3.imageSrc">
                    </div>
                    <div class=" watchText h-[45px] w-[380px]">
                ...
                <div class="watchLborder">
                    <div class="watchIMG">
                        <img class="imgWH" v-if="state.data4.imageSrc !== null" :src="state.data4.imageSrc">
                    </div>
                    <div class=" watchText h-[45px] w-[380px]">
            ...
            <div class="watchMainDiv">
                <div class="watchRborder">
                    <div class="watchIMG">
                        <img class="imgWH" v-if="state.data5.imageSrc !== null" :src="state.data5.imageSrc">
                    </div>
                    <div class="watchText h-[45px] w-[380px]">
                ...
                <div class="watchLborder">
                    <div class="watchIMG">
                        <img class="imgWH" v-if="state.data6.imageSrc !== null" :src="state.data6.imageSrc">
                    </div>
