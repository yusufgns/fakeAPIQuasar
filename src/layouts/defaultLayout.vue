<template>
    <div class="flex">
        <div class="w-[40%] break-words relative">
            ...
            <div class="mt-[80px] mb-[25px] h-screen px-[15px] py-[15px]">
                <div class="w-full h-screen">
                    <div v-if="reactiveData.data !== null" class="mb-[50px] border-b-[5px] pb-[25px]">
                        <div v-for="reactive in reactiveData">
                            <div class="text-center bg-gray-400 py-[5px] flex justify-between px-[10px] mb-[5px]">
                                <div>Sil</div>
                                {{ reactive.inputTitle }}
                                <div @click="watchToList(reactive)">Ön İzleme</div>
                            </div>
                            ...
                            <div v-if="reactive.data1.imageSrc !== null"
                                ...
                                <div class="flex items-center justify-center">
                                    <div>{{ reactive.data1.inputCount }}</div>
                            ...
                            <div v-if="reactive.data2.imageSrc !== null"
                                ...
                                <div class="flex items-center justify-center">
                                    <div>{{ reactive.data2.inputCount }}</div>
                                    <div class="w-[120px] max-w-[120px] h-[80px] max-h-[80px] ml-[20px]">
                                        <img class="w-[120px] max-w-[120px] h-[80px] max-h-[80px]"
                            ...
                            <div v-if="reactive.data3.imageSrc !== null"
                                ...
                                <div class="flex items-center justify-center">
                                    <div>{{ reactive.data3.inputCount }}</div>
                                    <div class="w-[120px] max-w-[120px] h-[80px] max-h-[80px] ml-[20px]">
                                        <img class="w-[120px] max-w-[120px] h-[80px] max-h-[80px]"
                            ...
                            <div v-if="reactive.data4.imageSrc !== null"
                                ...
                                <div class="flex items-center justify-center">
                                    <div>{{ reactive.data4.inputCount }}</div>
                                    <div class="w-[120px] max-w-[120px] h-[80px] max-h-[80px] ml-[20px]">
                                        <img class="w-[120px] max-w-[120px] h-[80px] max-h-[80px]"
                            ...
                            <div v-if="reactive.data5.imageSrc !== null"
                                ...
                                <div class="flex items-center justify-center">
                                    <div>{{ reactive.data5.inputCount }}</div>
                                    <div class="w-[120px] max-w-[120px] h-[80px] max-h-[80px] ml-[20px]">
                                        <img class="w-[120px] max-w-[120px] h-[80px] max-h-[80px]"
                            ...
                            <div v-if="reactive.data6.imageSrc !== null"
                                ...
                                <div class="flex items-center justify-center">
                                    <div>{{ reactive.data6.inputCount }}</div>
                                    <div class="w-[120px] max-w-[120px] h-[80px] max-h-[80px] ml-[20px]">
                                        <img class="w-[120px] max-w-[120px] h-[80px] max-h-[80px]"
                    ...
                    <div v-for="dataArrays in myData.dataArrays" class="mb-[25px]">
                        <div class="text-center bg-gray-400 py-[5px] flex justify-between px-[10px] mb-[5px]">
                            <div @click="listDelete(dataArrays)">Sil</div>
                        ...
                        <div v-if="dataArrays.data1.imageSrc !== null"
                            ...
                            <div class="flex items-center justify-center">
                                <div>{{ dataArrays.data1.inputCount }}</div>
                                <div class="w-[120px] max-w-[120px] h-[80px] max-h-[80px] ml-[20px]">
                                    <img class="w-[120px] max-w-[120px] h-[80px] max-h-[80px]"
                        ...
                        <div v-if="dataArrays.data2.imageSrc !== null"
                            ...
                            <div class="flex items-center justify-center">
                                <div>{{ dataArrays.data2.inputCount }}</div>
                                <div class="w-[120px] max-w-[120px] h-[80px] max-h-[80px] ml-[20px]">
                                    <img class="w-[120px] max-w-[120px] h-[80px] max-h-[80px]"
                        ...
                        <div v-if="dataArrays.data3.imageSrc !== null"
                            ...
                            <div class="flex items-center justify-center">
                                <div>{{ dataArrays.data3.inputCount }}</div>
                                <div class="w-[120px] max-w-[120px] h-[80px] max-h-[80px] ml-[20px]">
                                    <img class="w-[120px] max-w-[120px] h-[80px] max-h-[80px]"
                        ...
                        <div v-if="dataArrays.data4.imageSrc !== null"
                            ...
                            <div class="flex items-center justify-center">
                                <div>{{ dataArrays.data4.inputCount }}</div>
                                <div class="w-[120px] max-w-[120px] h-[80px] max-h-[80px] ml-[20px]">
                                    <img class="w-[120px] max-w-[120px] h-[80px] max-h-[80px]"
                        ...
                        <div v-if="dataArrays.data5.imageSrc !== null"
                            ...
                            <div class="flex items-center justify-center">
                                <div>{{ dataArrays.data5.inputCount }}</div>
                                <div class="w-[120px] max-w-[120px] h-[80px] max-h-[80px] ml-[20px]">
                                    <img class="w-[120px] max-w-[120px] h-[80px] max-h-[80px]"
                        ...
                        <div v-if="dataArrays.data6.imageSrc !== null"
                            ...
                            <div class="flex items-center justify-center">
                                <div>{{ dataArrays.data6.inputCount }}</div>
                                <div class="w-[120px] max-w-[120px] h-[80px] max-h-[80px] ml-[20px]">
                                    <img class="w-[120px] max-w-[120px] h-[80px] max-h-[80px]"
        ...
        <div class="w-[60%] h-full fixed right-0 bg-blue-50">
            <div v-if="watchForm.inputTitle !== null" class="w-full items-center justify-center flex">
...
const listDelete = async (e) => {
    ...
    myData.dataArrays = myData.dataArrays.filter((dataArrays) => dataArrays.id !== id)
}

const watchToList = (dataArrays, reactive) => {
    ...
    watchForm.inputTitle = reactive.inputTitle
    watchForm.data1 = reactive.data1
    watchForm.data2 = reactive.data2
    watchForm.data3 = reactive.data3
    watchForm.data4 = reactive.data4
    watchForm.data5 = reactive.data5
    watchForm.data6 = reactive.data6
}
